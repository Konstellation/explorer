const en = {
    ...
    params: {
        staking: {
            unbonding_time: 'Time duration of unbonding',
            max_validators: 'Maximum number of validators',
            max_entries: 'Max entries for either unbonding delegation or redelegation (per pair/trio)',
        ...
        slashing: {
            max_evidence_age: 'Max age for evidence',
            signed_blocks_window: 'Sliding window for downtime slashing',
            min_signed_per_window: 'Minimum blocks signed per window',
            downtime_jail_duration: 'Downtime unbond duration',
            slash_fraction_double_sign: 'Fraction of power slashed in case of double sign',
            slash_fraction_downtime: 'Fraction of power slashed for downtime',
        },
        distribution: {
            community_tax: 'Proportion of contributions to community funds',
            base_proposer_reward: 'Standard ratio of the block reward',
            bonus_proposer_reward: 'Maximum additional bonus ratio',
        ...
        gov: {
            ...
            max_deposit_period: 'Maximum period for Atom holders to deposit on a proposal. Initial value: 2 months',
            quorum: 'Minimum percentage of stake that needs to vote for a proposal to be considered valid',
